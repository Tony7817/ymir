...
type GetForgetPasswordCaptchaRequest struct {
	Phonenumber *string `json:"phone_number,optional"`
	Email       *string `json:"email,optional"`
}

type GetForgetPasswordCaptchaResponse struct {
...
type GetSignupCaptchaRequest struct {
	Phonenumber *string `json:"phone_number,optional"`
	Email       *string `json:"email,optional"`
}

type GetSignupCaptchaResponse struct {
	CreatedAt int64 `json:"created_at"`
	OK        bool  `json:"ok"`
}
