...
func (m *defaultStarModel) Insert(ctx context.Context, data *Star) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.Name, data.Rate, data.AvatarUrl, data.Description, data.CoverUrl, data.PosterUrl)
	}, ymirStarIdKey)
	return ret, err
}
...
func (m *defaultStarModel) Update(ctx context.Context, data *Star) error {
	...
	_, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.Name, data.Rate, data.AvatarUrl, data.Description, data.CoverUrl, data.PosterUrl, data.Id)
	}, ymirStarIdKey)
	return err
}
