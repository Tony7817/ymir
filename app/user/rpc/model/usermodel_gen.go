...
func (m *defaultUserModel) Insert(ctx context.Context, data *User) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.Username, data.Email, data.PhoneNumber, data.AvatarUrl, data.PasswordHash, data.IsActivated)
	}, ymirUserEmailKey, ymirUserIdKey, ymirUserPhoneNumberKey)
	return ret, err
}
...
func (m *defaultUserModel) Update(ctx context.Context, newData *User) error {
	...
	_, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, newData.Username, newData.Email, newData.PhoneNumber, newData.AvatarUrl, newData.PasswordHash, newData.IsActivated, newData.Id)
	}, ymirUserEmailKey, ymirUserIdKey, ymirUserPhoneNumberKey)
	return err
}
